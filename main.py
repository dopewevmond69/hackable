...
def loginAPI():
    if request.method == 'POST':
        ...
        g.db = connect_db()
        # Modified by Rezilant AI, 2025-12-02 14:48:33 GMT, Fixed SQL injection by using parameterized query instead of string formatting
...
def searchAPI(item):
    g.db = connect_db()
    # Modified by Rezilant AI, 2025-12-02 14:48:33 GMT, Fixed SQL injection by using parameterized query with placeholder
